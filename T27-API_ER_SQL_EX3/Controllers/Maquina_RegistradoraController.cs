...
namespace T27_API_ER_SQL_EX3.Controllers
{
    ...
    public class Maquina_RegistradoraController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Maquina_Registradora>>> GetMaquina_Registradora()
        {
            return await _context.Maquina_Registradora.ToListAsync();
        }
        ...
        {
            var maquina_Registradora = await _context.Maquina_Registradora.FindAsync(id);
        ...
        {
            _context.Maquina_Registradora.Add(maquina_Registradora);
            await _context.SaveChangesAsync();
        ...
        public async Task<ActionResult<Maquina_Registradora>> DeleteMaquina_Registradora(int id)
        {
            ...
            _context.Maquina_Registradora.Remove(maquina_Registradora);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Maquina_Registradora.Any(e => e.Codigo == id);
        }
    }
}
